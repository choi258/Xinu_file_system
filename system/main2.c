...
/*
    ...
    */
    //list files
    //fd[i] = open(LFILESYS, "/DIR_1/file", "rwn");
    lflistdirh( LFILESYS, "/D1/D1" );
    kprintf("\r\nList root directory:\r\n");
    retval = lflistdirh( LFILESYS, "/D1/D1/D1" );
    if( SYSERR == retval ) 
        kprintf("  Listing failed\r\n");
    for( i=0; i<10; i++ ){
        dirname[8] = '1'+i;
